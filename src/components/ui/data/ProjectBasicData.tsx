...
const ProjectBasicData = ({ id, name, status, description }: ProjectBasicDataProps) => {
    ...
    return (
        <div className="flex flex-col">
            <div className="flex items-center mb-3">
                <div className="font-bold mr-2 text-4xl">
                    {name}
                </div>
                <div className="ml-4">
                    <ButtonDropDown 
                        buttonLabel={pStatus===STATUS.ACTIVE? "active" : pStatus===STATUS.INACTIVE ? "inactive" : "dead" }
                        options={[
                            {
                                value: STATUS.ACTIVE,
                                label: "active"
                        ...
                        buttonClassName={`${pStatus===STATUS.ACTIVE? "bg-green-600" : pStatus===STATUS.INACTIVE ? "bg-yellow-500" : "bg-red-600" } px-6 py-0.5 text-white rounded`}
