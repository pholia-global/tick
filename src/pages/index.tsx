          ...
          <div className="h-full w-full flex flex-col mx-w-screen-sm md:flex-row md:mx-w-screen-2xl">
            <div className="h-96 md:h-full md:w-2/4">
              ...
              <div className="absolute top-6 p-6 flex flex-col md:top-32 lg:top-40 md:px-10">
                <div className="font-heading font-bold text-theme_dawn_pink text-5xl mb-8">tick</div>
                <div className="font-primary font-bold text-white text-3xl mb-4 lg:text-4xl xl:text-5xl">Take Control of<br/>Your Side Projects.</div>
                <div className="font-secondary font-light text-white text-xl mb-8">Manage your projects with ease.<br/>Sign up now!</div>
              </div>
            </div>
